...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 423.0, 245.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"watch" : 0
...
,
					"text" : "node.script simple-ws-server.js @autostart 1"
				}
...
, 			{
				"name" : "simple-ws-server.js",
				"bootpath" : "~/work/dev/projects/live-socket",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
